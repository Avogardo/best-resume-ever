    ...
    <div id="resume-header">
        <div id="header-left">
            ...
            <div id="info-flex">
                ...
                <span v-if="person.contact.website" id="website"><a :href='person.contact.website' target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i> {{person.contact.website}}</a></span>
                <span v-if="person.contact.github" id="github"><a :href='contactLinks.github' target="_blank"><i class="fa fa-github" aria-hidden="true"></i> {{person.contact.github}}</a></span>
            </div>
        </div>
        <div id="header-right">
            <div id="headshot"></div>
